      ...
      <form onSubmit={handleSubmit(onLoginUser)}>
        <Box sx={{ width: 350, padding: '10px 20px' }}>
              <Grid container spacing={2}>
                  ...
                  <Grid item xs={12}>
                      <Button disabled={showError} type='submit' color='secondary' className='circular-btn' size='large' fullWidth>Ingresar</Button>
                  </Grid>
                  ...
                  <Grid item xs={12} display='flex' flexDirection='column' justifyContent='end'>
                        ...
                        {                          
                          Object.values(providers).map((provider: any) => {
                            ...
                            return (
                              <Button key={provider.id} variant='outlined' fullWidth 
                                color='primary' 
                                sx={{ mb: 1 }} 
